use crate::{
    ...
    XSynth_RealtimeSynth, XSynth_Soundfont, XSynth_StreamParams,
};
use xsynth_core::{
...
#[no_mangle]
pub extern "C" fn XSynth_Realtime_SetLayerCount(handle: XSynth_RealtimeSynth, layers: u64) {
...
///
/// --Parameters--
/// - handle: The handle of the realtime synth instance
#[no_mangle]
